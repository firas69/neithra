class AppStrings {
  ...
  static const String takeNewTest = 'New Test';
  static const String home = 'Home';

  // Error messages
  static const String invalidJsonFormat = 'Invalid JSON format';
  static const String noQuestionsFound = 'No questions found in the test data';
  static const String fileReadError = 'Error reading file';
  static const String sessionNotFound = 'Practice session not found';
}
